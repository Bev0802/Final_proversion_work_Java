...
import Java.Toy_shop.Main;
import Java.Toy_shop.ToyClass;
import Java.Toy_shop.ConsoleView;
...
public class Methods {
     ...
     * @probab - возврадает список игрушек в котором расчитан процент вероятности выпадения в зависимости от количества элементво и количетва каждогой игрушки.
     */
     ...
     * @return Возвращает id случно выбранное в списке и находит название выигранной игрушки.
     */
